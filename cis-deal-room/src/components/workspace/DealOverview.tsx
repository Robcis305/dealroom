...
import type { WorkspaceStatus, ParticipantRole, DealKillerGroup, Stage } from '@/types';
...
interface DealOverviewProps {
  ...
  /** Open checklist and highlight a specific stage. */
...
export function DealOverview({
  ...
  isAdmin, role, onOpenChecklist, onChipClick, onStageClick,
}: DealOverviewProps) {
  const showReadiness =
    isAdmin ||
