...
Invoke /iimpeccable, which contains design principles, anti-patterns, and the **Context Gathering Protocol**. Follow the protocol before proceeding. If no design context exists yet, you MUST run /iimpeccable teach first. Additionally gather: what the interface is trying to accomplish.
...
- **Suggested command**: Which command could address this (from: /ianimate, /iquieter, /ishape, /ioptimize, /iadapt, /iclarify, /ilayout, /idistill, /idelight, /iaudit, /harden, /ipolish, /ibolder, /itypeset, /icritique, /icolorize, /ioverdrive)
...
2. **Design intent**: If the critique found a tonal mismatch, ask whether it was intentional. For example: "The interface feels clinical and corporate. Is that the intended tone, or should it feel warmer/ibolder/more playful?" Offer 2-3 tonal directions as options based on what would fix the issues found.
...
- Only recommend commands from: /ianimate, /iquieter, /ishape, /ioptimize, /iadapt, /iclarify, /ilayout, /idistill, /idelight, /iaudit, /harden, /ipolish, /ibolder, /itypeset, /icritique, /icolorize, /ioverdrive
...
- End with `/ipolish` as the final step if any fixes were recommended

After presenting the summary, tell the user:

> You can ask me to run these one at a time, all at once, or in any order you prefer.
>
> Re-run `/icritique` after fixes to see your score improve.