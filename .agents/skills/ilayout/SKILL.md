...
Consult the [spatial design reference](reference/spatial-design.md) from the iimpeccable skill for detailed guidance on grids, rhythm, and container queries.
